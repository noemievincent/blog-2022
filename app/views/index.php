                        ...
                        <?php foreach ($view->data['posts'] as $post): ?>
                            <div class="mt-6">
                                <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                                    <div class="flex items-center justify-between">
                                        <span class="font-light text-gray-600"><?= (new DateTime($post->published_at))->format('M j, Y - G:i') ?></span><a href="#"
                                                                                                                     class="px-2 py-1 font-bold text-gray-100 bg-gray-600 rounded hover:bg-gray-500"><?= ucwords($post->category) ?></a>
                                    </div>
                                    <div class="mt-2"><a href="index.php?action=show&id=<?= $post->id ?>"
                                    ...
                                    <div class="flex items-center justify-between mt-4">
                                        <a href="index.php?action=show&id=<?= $post->id ?>"
                                           class="text-blue-500 hover:underline">Read more<span class="sr-only"> about <?= $post->title ?></span></a>
                                        <div><a href="#"
                                                class="flex items-center"><img
                                                        src="<?= $post->author_avatar ?>"
                                                        alt="avatar"
                                                        class="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block">
                                                <h1 class="font-bold text-gray-700 hover:underline"><?= $post->author_name ?></h1>
                                            </a></div>
                                    </div>
                                </div>
                            </div>
