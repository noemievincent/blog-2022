<div class="hidden w-4/12 -mx-8 lg:block">
            ...
            <ul class="-mx-4">
                <?php foreach ($view->data['authors'] as $author_name => $author_infos): ?>
                    <li class="flex items-center mb-3"><img
                        ...
                        <p><a href="#"
                              class="mx-1 font-bold text-gray-700 hover:underline"><?= $author_name ?></a><span
                                    class="text-sm font-light text-gray-700">Created <?= $author_infos->posts_count ?> Posts</span>
                        </p>
                    </li>
                <?php endforeach ?>
    ...
    <div class="px-8 mt-10">
        ...
        <div class="flex flex-col max-w-sm px-8 py-6 mx-auto bg-white rounded-lg shadow-md">
            ...
            <div class="mt-4"><a href="index.php?action=show&id=<?= $view->data['most_recent_post']->id ?>"
