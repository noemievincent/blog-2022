<aside class="hidden w-4/12 -mx-8 lg:block">
        ...
        <div class="flex flex-col max-w-sm px-4 py-6 mx-auto bg-white rounded-lg shadow-md">
            <ul>
                ...
                <?php foreach ($view->data['categories'] as $category): ?>
                    <li class="mb-3"><a href="index.php?category=<?= $category->slug ?>"
    ...
    <section class="px-8 mt-10">
        ...
        <div class="flex flex-col max-w-sm px-8 py-6 mx-auto bg-white rounded-lg shadow-md">
            ...
            <div class="mt-4">
                <a href="index.php?action=show&slug=<?= $view->data['most_recent_post']->post_slug ?>"
                   class="font-bold text-lg font-medium text-gray-700 hover:underline"><?= $view->data['most_recent_post']->post_title ?></a>
            </div>
            <div class="flex items-center justify-between mt-4">
                <div class="flex items-center"><img
                            src="<?= $view->data['most_recent_post']->post_author_avatar ?>"
                            alt="avatar"
